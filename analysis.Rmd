...
#### Question 1: What is the distribution of the Productivity_Change Variable?
```{r}
...
## Analysis
#### Question 2: What is the impact of working from home on productivity change? - Stress Level & Working from Home
```{r}
...
#### Question 2:  What is the impact of working from home on productivity change? - Sector
```{r}
...
#### Question 2:  What is the impact of working from home on productivity change? - Sector & Working from Home
```{r}
...
#### QUestion 3: Are there significant correlations between productivity_change and other numeric variables? 
```{r}
