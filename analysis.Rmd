...
#### Question 7: Which sectors have experienced the highest and lowest average productivity changes?
```{r}
ggplot(sector_analysis, aes(x = reorder(Sector, -Average_Productivity_Change), y = Average_Productivity_Change)) +
...
#### Question 8: Is there a significant difference in productivity change between employees who experienced a salary cut and those with stable salaries?
```{r}
...
#### Question 9: What are the key takeaways or recommendations based on our analysis?
```{r}
...
#### Question 10: What can we improve if this analysis were conducted again?
```{r}
